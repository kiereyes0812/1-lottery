        ...
        <nav class="content-block toc-card" data-toc-static aria-label="Table of contents">
          ...
          <div class="toc-panel" hidden>
            ...
            <div class="section inner-section">
                ...
                <p>We want to build trust with all our players. This policy explains what information we
                    collect, why we collect it, and how we keep it safe. We have kept the language simple so
                    that everyone can easily understand it.</p>
            </div>
            ...
            <div class="section inner-section">
                ...
                <p>Your information is used to keep your account running smoothly. We use it for communication,
                    sending updates, improving performance, and ensuring fairness. We never misuse or abuse your
                    personal data.</p>
            </div>
            ...
            <div class="section inner-section">
                ...
                <p>We use secure systems to store and safeguard your data. Only authorised staff have access,
                    and we carry out regular checks to maintain data safety.</p>
            </div>

            <div class="section inner-section">
                <h2>Cookies</h2>
                <p>Cookies are small files that help us improve your experience on the site or app. They
                    remember preferences and make navigation easier. You can disable cookies in your browser
                    settings, but some features may not work properly without them.</p>
            </div>
            ...
            <div class="section inner-section">
                ...
                <p>1 Lottery Game is not designed for underage players. We do not knowingly collect data from
                    minors. If we ever receive such data, it will be deleted immediately. Parents and guardians
                    are responsible for preventing underage access.</p>
            </div>

            <div class="section inner-section">
                <h2>Third-Party Services</h2>
                <p>We may use third-party tools or services to improve gameplay. These services follow their own
                    privacy policies. We recommend checking those policies to understand how they handle your
                    data.</p>
            </div>

            <div class="section inner-section">
                <h2>Links to Other Websites</h2>
                <p>Some parts of our site may have links to other websites. We are not responsible for how those
                    sites handle privacy. We encourage you to read their policies separately.</p>
            </div>

            <div class="section inner-section">
                <h2>Changes to This Privacy Policy</h2>
                <p>We may update this Privacy Policy from time to time. Major updates will be posted on this
                    page. We recommend that you check this page regularly to stay informed.</p>
            </div>

            <div class="section inner-section">
                <h2>Your Consent</h2>
                <p>By using the 1 Lottery Game, you agree to the terms of this Privacy Policy. If you do not
                    agree, you should stop using our services. Please also refer to our Terms & Conditions and
                    <a href="https://1lotteryy.io/about-us/">About Us</a> pages for more information.</p>
            </div>

            <div class="section inner-section">
                <h2>Contact Us</h2>
                <p>If you have any questions or concerns about your data, please contact us through our Contact
                    Us page or via email. Our team will be happy to assist you.</p>
            </div>

            <div class="section inner-section">
                <h2>Final Words</h2>
                <p>At 1 Lottery Game, we are committed to protecting your privacy. Your information is used
                    solely to ensure a safe and fair gaming experience. Thank you for trusting us and being a
                    part of the 1 Lottery Game community.</p>
            </div>
        </div>
    </section>
